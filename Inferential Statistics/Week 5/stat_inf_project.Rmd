...
Step 5: Interpret results
  With very high chi-squared value resulting in very low p-value, we can say that it is very unlikely that the difference of the proportion of the opinion on abortion topic in each class is due to chance, and thus  reject the null hypothesis and conclude that the opinion on abortion is dependent to the social class